...
const StaffCheckinPage = () => {
  ...
  const { isScanning, videoRef, startScanning, stopScanning } = useQRCodeScanner({
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Check-in SanjaPass</h1>
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Histórico dos últimos check-ins realizados
                </CardDescription>
              </CardHeader>
              <CardContent>
